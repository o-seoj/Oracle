...
GRANT CONNECT, RESOUCE,UNLIMITED TABLESPACE TO SHOP;
...
-- 실습 1-25
SELECT ORD_PNO AS "주문 상품번호", SUM(ORD_CNT) AS "총 주문 수량" FROM ORDERS GROUP BY ORD_PNO ORDER BY ORD_PNO ASC;
...
-- 실습 1-28
SELECT ORD_PNO, ORD_CID, SUM(ORD_CNT) AS "총 주문 수량" FROM ORDERS
